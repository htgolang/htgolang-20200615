...
func init() {
	// 默认初始化数据， 省的总要输入
	users = []User{
		{1, "kk", time.Now().AddDate(1, 1, 1), "18777777777", "hangzhou", "kk"},
		{2, "ll", time.Now().AddDate(2, 2, 2), "18888888888", "shanghai", "ll"},
		{3, "kl", time.Now().AddDate(3, 3, 3), "18999999999", "beijing", "kl"},
		{4, "ko", time.Now().AddDate(4, 4, 4), "19000000000", "jiangxi", "ko"},
	}
}
