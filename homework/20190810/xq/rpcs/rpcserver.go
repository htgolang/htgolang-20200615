...
func main()  {
	...
	flag.StringVar(&addr, "l", "127.0.0.1:10000", "listen addr")
	flag.StringVar(&dataDir, "d", filepath.Join(baseDir, "datas"), "datadir")
	flag.BoolVar(&help, "h", false, "Help")

	flag.Usage = func() {
		fmt.Println("Usage: server [-L 127.0.0.1:10000]")
		fmt.Println("Options: ")
		flag.PrintDefaults()
	}
	...
	logFile, err := os.OpenFile(filepath.Join(baseDir, "server.log"), os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0X755)
	if err != nil {
		fmt.Println(err)
		os.Exit(-1)
	}
